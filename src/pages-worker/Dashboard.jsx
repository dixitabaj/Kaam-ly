...
export default function WorkerDashboard() {
  ...
  <main 
    style={{ 
      marginLeft: "320px",           // ✅ Push content right of sidebar
      width: "calc(100% - 320px)",   // ✅ Take remaining width
      maxWidth: 1200, 
      padding: "2rem",
      paddingBottom: "4rem"
    }}
  ...
  >
            ...
            {/* STAT CARDS */}
            <div style={{ display: "flex", gap: "1rem", marginBottom: "1.75rem", flexWrap: "wrap" }} className="stat-cards">
            ...
            {/* MAIN GRID */}
            <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "1.5rem" }} className="main-grid">

              {/* LEFT */}
              <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>

                {/* 2×2 Grid: Donut + Earnings */}
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "auto auto", gap: "1rem" }} className="donut-earnings-grid">
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
          ...
          .donut-earnings-grid > div:first-child {
